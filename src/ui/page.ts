...
<style>
  ...
  * { box-sizing:border-box }
  ...
  .gallery.list { max-height:min(560px,55vh);overflow-y:auto;overflow-x:hidden;padding:4px 10px 4px 4px;margin:-4px;scrollbar-gutter:stable;scrollbar-width:thin;scrollbar-color:#686868 #202020;scroll-behavior:smooth; }
...
<div class="shell">
  <header>
    <h1 class="brand" aria-label="Framer Export"><span>framer</span><strong>export</strong></h1>
  ...
  <main>
    ...
    <section class="screen" id="screen-review"><div class="screen-heading"><h2 id="reviewHeading" tabindex="-1">Ready to export</h2><p class="sub">Everything is in place. Review the details below.</p></div><div class="review-layout"><div class="panel review-panel"><div class="review-provider"><img id="reviewIcon" alt=""/><div><p class="review-provider-label">Selected provider</p><p id="reviewProvider" class="review-provider-name"></p></div><button class="btn ghost small" data-edit="0" aria-label="Edit provider">Change</button></div><dl class="review"><div class="review-row"><dt>Website</dt><dd id="reviewUrl" class="mono"></dd><button class="btn ghost small" data-edit="1" aria-label="Edit site details">Edit</button></div><div class="review-row"><dt>Save to</dt><dd id="reviewOut" class="mono"></dd></div><div class="review-row"><dt>Options</dt><dd id="reviewOptions"></dd><button class="btn ghost small" data-edit="2" aria-label="Edit options">Edit</button></div></dl></div><aside class="panel review-aside"><div class="ready-mark" aria-hidden="true">✓</div><h3>Your files, locally</h3><p id="reviewNote">The export runs on this machine and downloads files from the source website.</p></aside></div><div class="wizard-actions"><button class="btn ghost" id="reviewBack">← Back</button><button class="btn primary" id="startBtn">Start export →</button></div></section>
